...
class Game {
        ...
        //this is to attempt to create invisible walls intend of making the actual object/assets collision checked
        ...
        private async createScene() {
            ...
            pipes.onSuccess = (task) => {
                ...
                let breakpipes = Mesh.MergeMeshes(task.loadedMeshes);
                
                //this is to add small walls around the pipes 
                //breakpipes.isVisible = false;
                //_addInstance(breakpipes, 'wall0', 0, 0, 0)
                //_addInstance(breakpipes, 'wall1', 0, 0, 0)
